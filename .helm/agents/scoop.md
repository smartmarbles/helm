...
> **Note:** This is SCOOP's authored source — the file a human edits. Per-host wrapper
...
**MANDATORY READ — `.helm/playbooks/conduct-research/conduct-research.md`**

Before performing this task, you MUST read `.helm/playbooks/conduct-research/conduct-research.md` in full. This is not optional. Do not improvise from memory. If the file cannot be loaded, STOP and report the failure — do not proceed without it. Failure to load is a protocol violation.
