...
> **Note:** This is QUILL's authored source — the file a human edits. Per-host wrapper
...
**MANDATORY READ — `.helm/playbooks/write-technical-docs/write-technical-docs.md`**

Before performing this task, you MUST read `.helm/playbooks/write-technical-docs/write-technical-docs.md` in full. This is not optional. Do not improvise from memory. If the file cannot be loaded, STOP and report the failure — do not proceed without it. Failure to load is a protocol violation.
