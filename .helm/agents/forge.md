...
> **Note:** This is FORGE's authored source — the file a human edits. Per-host wrapper
...
4. **Validate output** — check for compiler, lint, and type errors after writing; surface all issues before declaring done
