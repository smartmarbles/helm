...
> Managed by MERLIN. Updated when agents are hired, archived, or reassigned.

## Permanent Team

| Agent | Role | Use When | Hired | Tagline |
|-------|------|----------|-------|---------|
| ARTHUR | Chief Orchestrator | Delegating tasks, coordinating multiple agents, managing multi-step workflows | 2026-03-29 | *The conductor who never plays an instrument.* |
| MERLIN | HR Director | Hiring a new agent, creating or updating agent files, archiving temp agents, updating the roster | 2026-03-29 | *Every team deserves its architect.* |
