...
run_date: YYYY-MM-DD
test_corpus: artifacts/testing/test-plan.md
test_cases_run: [TC-001, TC-003, ...]
rubric_version: {{RUBRIC_VERSION}}  # read the current version from §8 of this file
---
```
...
## Reproduction
- Test corpus: `artifacts/testing/test-plan.md`
- Test cases run: TC-XXX, TC-YYY, …
- Rubric: `artifacts/testing/probe-scoring-rubric.md` v{{RUBRIC_VERSION}}
- Model: <model tag>
```
...
- **v1.1.1** — 2026-04-26 — corrected stale `artifacts/spec00*` paths to `artifacts/testing/` throughout; made Reproduction template rubric version a `{{RUBRIC_VERSION}}` placeholder. No scoring changes.
